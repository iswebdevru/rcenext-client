...
export default function Header() {
  return (
    <header className="fixed left-0 top-0 right-0 z-50 h-14 transition-colors border-b common-border bg-zinc-100 text-black dark:text-white dark:bg-zinc-800">
